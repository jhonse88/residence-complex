...
import { HiChevronLeft, HiChevronRight, HiStar, HiOutlineStar } from 'react-icons/hi'
    ...
    <HStack spacing={1} align='center'>
      {[1, 2, 3, 4, 5].map(star => (
        <Icon
          ...
          color={star <= (evaluation?.Qualification || 0) ? starColor : 'gray.300'}
          boxSize={4}
        />
      ))}
                ...
                <Flex justify='space-between' mb={4}>
                  ...
                  {currentRequest?.Id ? (
                    <Button
                      ...
                      {evaluation ? 'Ver Calificación' : 'Calificar Servicio'}
                    </Button>
                  ) : null}
                </Flex>
                ...
                <SimpleGrid columns={1} spacingY={4}>
                  <FormControl isInvalid={!!errors.ApplicationDate} isRequired>
                    ...
                    <Input
                      ...
                      value={
                        currentRequest?.ApplicationDate ? formatToDatetimeLocal(currentRequest.ApplicationDate) : ''
                      }
                      ...
                      isReadOnly
                    />
                    <FormErrorMessage fontSize='xs'>{errors.ApplicationDate}</FormErrorMessage>
                  </FormControl>
